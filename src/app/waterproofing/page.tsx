...
const areas = [
  ...
  { name:'Exterior Wall', problem:'Rain penetration through cracks, porous plaster, failed joints.', system:'Biowash → Crack filling → Damp arrestor primer → Weather-resistant emulsion', products:['Azura Biowash','Arest Crack Filler','Azura Damp Arrestor Primer','Azura Weather Shield 15'], link:'/products/decorative' },
  ...
  return (
    <>
      <section className="relative text-white overflow-hidden">
        <img src="/img/heroes/hero-waterproof.png" alt="" className="absolute inset-0 w-full h-full object-cover" />
