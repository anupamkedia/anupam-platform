  ...
  return (
    <>
      <section className="relative text-white overflow-hidden">
        <img src="/img/heroes/hero-failures.jpg" alt="" className="absolute inset-0 w-full h-full object-cover" />
