    ...
    <>
      <section className="bg-[var(--color-navy)] text-white py-16 md:py-24">
        <div className="container-wide px-4">
          ...
          <p className="text-lg text-white/50 max-w-2xl">Guides, insights, and technical knowledge from our coating experts.</p>
        </div>
      </section>
      {categories.length > 0 && (
              ...
              {posts.map((post: any) => (
                <Link key={post.id} href={`/blog/${post.slug}`} className="card card-hover group">
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="text-lg font-bold text-gray-800 group-hover:text-[var(--color-navy)] transition mb-2">{post.title}</h3>
