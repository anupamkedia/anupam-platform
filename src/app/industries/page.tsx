  ...
  return (
    <>
      <section className="relative text-white overflow-hidden">
        <img src="/img/heroes/hero-industries.jpg" alt="" className="absolute inset-0 w-full h-full object-cover" />
