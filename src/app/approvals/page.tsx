    ...
    <>
      <section className="bg-[var(--color-navy)] text-white py-16 md:py-24">
        <div className="container-wide px-4">
          <p className="text-white/50 text-sm font-medium mb-2 tracking-wider uppercase">Approvals</p>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Approvals & Certifications</h1>
          <p className="text-lg text-white/50 max-w-2xl">Trusted and approved by India&apos;s most demanding institutions — Railways, Defence, Energy, and Infrastructure.</p>
        </div>
      </section>
        ...
        <div className="container-wide">
          {categories.map((cat) => (
            <div key={cat} className="mb-12 last:mb-0">
              <h2 className="text-2xl font-bold text-[var(--color-navy)] mb-6 flex items-center gap-2"><Shield size={24} /> {cat}</h2>
