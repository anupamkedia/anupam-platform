...
const systems = [
  ...
  { code:'AP-DEC-001', name:'Exterior Wall — Premium', env:'Atmospheric', life:'15 yrs', primer:'Azura Damp Arrestor Primer', intermediate:'Cement Putty', topcoat:'Azura Antidirt Long Life (2 coats)', dft:'Per spec', category:'Decorative', link:'/products/decorative' },
  ...
  return (
    <>
      <section className="relative text-white overflow-hidden">
        <img src="/img/heroes/hero-systems.jpg" alt="" className="absolute inset-0 w-full h-full object-cover" />
