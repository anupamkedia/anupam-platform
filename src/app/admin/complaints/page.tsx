...
export default function AdminComplaintsPage() {
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 mb-6">Track all complaints by category and severity. Assign to technical team, manage resolution workflow and SLA.</p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
        ...
        <p className="text-gray-500 text-sm">Complaint Management — full CRUD with Supabase integration.</p>
