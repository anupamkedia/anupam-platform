...
export default function AdminPagesPage() {
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 mb-6">Visual page builder for managing website content, banners, menus, and SEO settings.</p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
        ...
        <p className="text-gray-500 text-sm">CMS Pages — full CRUD with Supabase integration.</p>
