...
export default function AdminUsersPage() {
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 mb-6">Manage user accounts, role assignments, permissions, and territory-based data access controls.</p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
        ...
        <p className="text-gray-500 text-sm">Users & Roles — full CRUD with Supabase integration.</p>
