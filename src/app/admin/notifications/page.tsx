...
export default function AdminNotificationsPage() {
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 mb-6">Configure notification templates for email, SMS, WhatsApp, and push notifications by event type.</p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
        ...
        <p className="text-gray-500 text-sm">Notification Templates — full CRUD with Supabase integration.</p>
