  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Approvals Manager</h1>
        <button className="btn-primary text-sm"><Plus size={16} className="mr-2" /> Add New</button>
      </div>
      <p className="text-sm text-gray-500 mb-6">Add, edit, and manage institutional approvals, certifications, and registration documents.</p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
        ...
        <p className="text-gray-500 text-sm">Approvals Manager — full CRUD with Supabase integration.</p>
