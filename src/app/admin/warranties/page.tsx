...
export default function AdminWarrantiesPage() {
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 mb-6">View warranty registrations, manage inspections, generate QR-coded certificates, and process claims.</p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
        ...
        <p className="text-gray-500 text-sm">Warranty Management — full CRUD with Supabase integration.</p>
