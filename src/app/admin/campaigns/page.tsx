  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Campaign Engine</h1>
        <button className="btn-primary text-sm"><Plus size={16} className="mr-2" /> Add New</button>
      </div>
      <p className="text-sm text-gray-500 mb-6">Create and manage loyalty campaigns for dealers, painters, and customers. No-code campaign builder with targeting, tracking, and leaderboards.</p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
        ...
        <p className="text-gray-500 text-sm">Campaign Engine — full CRUD with Supabase integration.</p>
