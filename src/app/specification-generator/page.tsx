...
export default function SpecificationGenerator() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F4]">
      {/* ---------- masthead ---------- */}
      <div className="print:hidden bg-[#0B2A5B] text-white">
        <div className="max-w-7xl mx-auto px-5 py-12">
          <p className="text-[11px] tracking-[0.28em] uppercase text-[#7FA8DC] mb-3">Specifier Centre</p>
          <h1 className="text-3xl md:text-5xl font-semibold leading-[1.1] max-w-3xl">
            Coating Specification Generator
          </h1>
          <p className="mt-5 text-[15px] leading-relaxed text-blue-100/90 max-w-2xl">
