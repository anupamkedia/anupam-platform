  ...
  return (
    <>
      <section className="relative text-white overflow-hidden">
        <img src="/img/app/decorative/dec-exterior-villa.png" alt="" className="absolute inset-0 w-full h-full object-cover" />
        <div className="absolute inset-0 bg-gray-500/85" />
        <div className="container-wide px-4 py-16 md:py-24 relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Get in Touch</h1>
          <p className="text-lg text-white/50 max-w-2xl">Whether it&apos;s a technical query, quotation request, or dealer enquiry — our team is ready to help.</p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="font-bold text-[var(--color-navy)] mb-4 flex items-center gap-2"><MapPin size={20} /> Head Office</h3>
                <p className="text-gray-700 text-sm leading-relaxed">{SITE.headOffice}</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="font-bold text-[var(--color-navy)] mb-4 flex items-center gap-2"><Factory size={20} /> Factory</h3>
                <p className="text-gray-700 text-sm leading-relaxed">{SITE.factory}</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="font-bold text-[var(--color-navy)] mb-4 flex items-center gap-2"><Phone size={20} /> Phone</h3>
                <p className="text-gray-700 text-sm">{SITE.phone}</p>
                <p className="text-gray-700 text-sm">{SITE.phone2}</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="font-bold text-[var(--color-navy)] mb-4 flex items-center gap-2"><Mail size={20} /> Email</h3>
                <a href={`mailto:${SITE.email}`} className="text-[var(--color-navy)] text-sm font-medium">{SITE.email}</a>
              </div>
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="font-bold text-[var(--color-navy)] mb-4 flex items-center gap-2"><Clock size={20} /> Office Hours</h3>
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-8">
                ...
                {status === 'done' ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-sm text-gray-400">Or call us directly: <a href={`tel:${SITE.phone.replace(/-/g,'')}`} className="text-[var(--color-navy)] font-medium">{SITE.phone}</a></p>
