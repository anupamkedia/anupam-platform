...
const solutionsData: Record<string, SolutionData> = {
  'railway-coaches': {
    ...
    industry: 'Railways',
    icon: '🚂',
    heroImage: '/img/heroes/railway-coach.png',
  ...
  'railway-bogies': {
    ...
    industry: 'Railways',
    icon: '🔧',
    heroImage: '/img/heroes/structural-steel.png',
  ...
  'marine-hull': {
    ...
    icon: '🚢',
    heroImage: '/img/heroes/naval-vessel.png',
  ...
  'real-estate': {
    ...
    icon: '🏢',
    heroImage: '/img/heroes/living-room.png',
  ...
  'oil-gas': {
    ...
    industry: 'Oil & Gas',
    icon: '⛽',
    heroImage: '/img/heroes/factory-aerial.png',
