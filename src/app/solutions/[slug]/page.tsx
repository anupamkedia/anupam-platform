...
const solutionsData: Record<string, SolutionData> = {
  'railway-coaches': {
    ...
    industry: 'Railways',
    icon: '🚂',
    heroImage: '/img/heroes/railway-coach.jpg',
  ...
  'railway-bogies': {
    ...
    industry: 'Railways',
    icon: '🔧',
    heroImage: '/img/heroes/structural-steel.jpg',
  ...
  'marine-hull': {
    ...
    icon: '🚢',
    heroImage: '/img/heroes/naval-vessel.jpg',
  ...
  'real-estate': {
    ...
    icon: '🏢',
    heroImage: '/img/heroes/living-room.jpg',
  ...
  'oil-gas': {
    ...
    industry: 'Oil & Gas',
    icon: '⛽',
    heroImage: '/img/heroes/hero-oil-gas.jpg',
  ...
  'tank-lining': {
    ...
    icon: '💧',
    heroImage: '/img/heroes/hero-tank-lining.jpg',
  ...
  'fire-protection': {
    ...
    industry: 'Safety',
    icon: '🔥',
    heroImage: '/img/heroes/hero-fire-protection.jpg',
  ...
  'industrial-flooring': {
    ...
    industry: 'Industrial',
    icon: '🏭',
    heroImage: '/img/heroes/hero-industrial-flooring.jpg',
  ...
  'power-cement': {
    ...
    icon: '⚡',
    heroImage: '/img/heroes/factory-aerial.jpg',
