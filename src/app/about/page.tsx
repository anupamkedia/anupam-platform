    ...
    <>
      ...
      <section className="relative text-white overflow-hidden">
        ...
        <div className="container-wide px-4 py-20 md:py-28 relative z-10">
          ...
          <p className="text-xl text-white/50 max-w-2xl">Charting the Spectrum of Success Since 1972</p>
        </div>
      </section>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-wide max-w-4xl">
          <h2 className="text-3xl font-bold text-[var(--color-navy)] mb-8">Chairman&apos;s Message</h2>
            ...
            <div className="md:flex gap-8">
              <div className="md:w-48 shrink-0 mb-6 md:mb-0">
                ...
                <div className="text-center mt-3">
                  ...
                  <div className="text-sm text-[var(--color-navy)]">{CHAIRMAN_MESSAGE.title}</div>
                </div>
              </div>
              <div>
                ...
                <p className="font-bold text-[var(--color-navy)] text-lg">{CHAIRMAN_MESSAGE.name}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-wide">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="bg-gradient-to-br from-brand-50 to-blue-50 rounded-2xl p-8">
              ...
              <h3 className="text-2xl font-bold text-[var(--color-navy)] mb-4">Our Mission</h3>
            ...
            <div className="bg-gradient-to-br from-brand-50 to-blue-50 rounded-2xl p-8">
              ...
              <h3 className="text-2xl font-bold text-[var(--color-navy)] mb-4">Our Vision</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {CORE_VALUES.map((val, i) => (
              <div key={i} className="bg-white border border-gray-100 rounded-xl p-5 hover:shadow-lg hover:border-brand-200 transition text-center">
                <Award className="mx-auto text-[var(--color-navy)] mb-3" size={28} />
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {TEAM.map((member, i) => (
              <div key={i} className="text-center group">
                ...
                <p className="text-xs text-[var(--color-navy)]">{member.role}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="section-padding gradient-light">
        <div className="container-wide text-center max-w-3xl">
          <div className="bg-brand-500 text-white rounded-2xl p-8 md:p-12">
            ...
            <p className="text-white/50 text-lg leading-relaxed">Our paints are enhanced with Carbon Nano-Struct Technology — for coatings that Outperform and Outlast. This proprietary technology delivers superior adhesion, chemical resistance, and durability across all product ranges.</p>
          </div>
        </div>
      </section>
    </>
