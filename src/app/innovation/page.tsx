...
const technologies = [
  ...
  { name: 'Polysiloxane Technology', desc: 'Silicone-modified systems providing exceptional water impermeability, UV resistance, and hydrophobic film formation for exterior applications.', uses: ['Exterior walls', 'Bridges', 'Structural steel'], products: ['Azura Weather Shield 15', 'Polysiloxane Topcoat'] },
...
return (
  <>
    <section className="relative text-white overflow-hidden">
        <img src="/img/app/industrial/ind-highbuild.png" alt="" className="absolute inset-0 w-full h-full object-cover" />
