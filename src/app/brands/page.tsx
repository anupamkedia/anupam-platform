...
const brands = [
  ...
  { name:'Arest', tier:'Waterproofing', logo:'/img/logos/arest.jpg', color:'#0E7490', bg:'#ECFEFF', desc:'Complete waterproofing and damp-proofing solutions. Base Coat, Cool Roof Coat, Crack Filler, and Damp Block 2K — protecting buildings from water damage.', products:['Premium Waterproofing Base Coat','Cool Roof Coat','Crack Filler','Damp Block 2K'], shots:['arest-base-coat.jpg','arest-roof-coat.jpg','arest-crack-fillers.jpg','arest-damp-block-2k.jpg'] },
];
