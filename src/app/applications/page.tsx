...
const categories = [
  { name:'Steel & Metal', slug:'steel', count:18, img:'/img/app/industrial/ind-structural-spray.jpg', color:'var(--accent-industrial)',
  ...
  { name:'Railway', slug:'railway', count:11, img:'/img/app/railway/rly-coach-painting.jpg', color:'var(--accent-railway)',
  ...
  { name:'Marine', slug:'marine', count:11, img:'/img/app/marine/mar-drydock.jpg', color:'var(--accent-marine)',
  ...
  { name:'Buildings', slug:'buildings', count:12, img:'/img/app/decorative/dec-living-premium.jpg', color:'var(--accent-decorative)',
  ...
  return (
    <>
      <section className="relative text-white overflow-hidden">
        <img src="/img/app/industrial/ind-structural-spray.jpg" alt="" className="absolute inset-0 w-full h-full object-cover" />
